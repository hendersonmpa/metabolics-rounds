...
- Urine
  - Diagnosis of CUD
** ERNDIM Plasma Acylcarnitines Survey
...
\node[label](ms2l)[below=of ms2,yshift=3em]{selected m/z};
\draw[->](ms1) -- (cc);
\draw[->](cc) -- (ms2);
...
- As compared to LC-MS/MS 
*** Pros
- ~2 min analysis time
- Amino acids  quantified simultaneously

*** Cons
- Variability in DBS sample as described above
- Iso-baric compounds
 - C5DC-Bu^2 and C10-OH-Bu
- Fewer AC quantified
...
*** Pros
- 44 vs ~30 acylcarnitines quantified
*** Cons
- Can not measure C0
- Can not measure 
