...
\begin{frame}[label={sec:orgheadline4}]{FIA-MS/MS schematic}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgheadline5}]{FIA-MS/MS sample}
\begin{itemize}
...
\begin{frame}[label={sec:orgheadline6}]{FIA-MS/MS Method}
\begin{itemize}
...
\begin{frame}[label={sec:orgheadline7}]{Fragmentation}
\definesubmol{x}{-[1,.6]-[7,.6]}
\centering
...
\begin{frame}[label={sec:orgheadline8}]{Overestimation of Free Carnitine}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgheadline9}]{Why derivatize?}
\includegraphics[width=.9\linewidth]{./figures/ionization.png}
\end{frame}

\begin{frame}[label={sec:orgheadline10}]{MRM is used to detected dicarboxylic acylcarnitines}
\begin{itemize}
...
\begin{frame}[label={sec:orgheadline11}]{FIA-MS/MS Acylcarnitine Scan}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgheadline12}]{Pros and Cons of Butanol  FIA-MSMS for Aceylcarnitines}
\begin{block}{Pros}
\begin{itemize}
\item Speed
\item Sensitivity
