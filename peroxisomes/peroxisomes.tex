...
\label{sec:org63881ee}
\begin{frame}[label={sec:org672955e}]{Peroxisomal FA oxidation}
\begin{itemize}
...
\begin{frame}[label={sec:orgee4aca4}]{Peroxisomal Disorders}
\begin{itemize}
...
\begin{frame}[label={sec:org01b5bb1}]{Peroxisomal Disorders (Exam?)}
\begin{itemize}
...
\begin{frame}[label={sec:orgc7ceaf4}]{Non-mitochondrial FA metabolism}
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{./figures/non_mito_FA_met.png}
\caption[Non-mitochondrial FA metabolism]{\label{fig:orgaf2ac33}
Non-mitochondrial FA metabolism}
\end{figure}
\end{frame}

\section{X-linked Adrenoleukodystrophy}
\label{sec:org5e55b65}
\begin{frame}[label={sec:orgd86a733}]{Clinical Presentation}
\begin{itemize}
...
\begin{frame}[label={sec:org773f15b}]{Metabolic Derangement}
\begin{itemize}
...
\begin{frame}[label={sec:org0d38fbe}]{Genetics}
\begin{itemize}
...
\begin{frame}[label={sec:org693073e}]{Diagnostic Tests}
\begin{itemize}
...
\begin{frame}[label={sec:org67a915b}]{Treatment}
\begin{itemize}
...
\label{sec:org603d61d}
\begin{frame}[label={sec:orgc1d36b1}]{Clinical Presentation}
\begin{itemize}
...
\begin{frame}[label={sec:org7b63204}]{Metabolic Derangement}
\begin{itemize}
...
\begin{frame}[label={sec:orgca71c17}]{Genetics}
\begin{itemize}
...
\begin{frame}[label={sec:org436a7c3}]{Diagnostic Tests}
\begin{itemize}
...
\begin{frame}[label={sec:org7b16a3f}]{Treatment}
\begin{itemize}
...
\label{sec:orga1c9528}
\begin{frame}[label={sec:org04817df}]{Clinical Presentation}
\begin{itemize}
...
\begin{frame}[label={sec:org667977d}]{Metabolic derangement}
\begin{itemize}
...
\caption[oxidation of phytanic]{\label{fig:org59446f3}
Oxidation of Phytanic Acid}
\end{figure}
\end{frame}

\begin{frame}[label={sec:orga486a73}]{Genetics}
\begin{itemize}
...
\begin{frame}[label={sec:org2f75ede}]{Diagnostic Tests}
\begin{itemize}
...
\begin{frame}[label={sec:org922d73e}]{Treatment}
\begin{itemize}
...
\label{sec:orgd1c4a77}
\begin{frame}[label={sec:org86465eb}]{Clinical Presentation}
\begin{itemize}
...
\begin{frame}[label={sec:org6bc9954}]{Metabolic Derangement}
\begin{itemize}
...
\begin{frame}[label={sec:orgcd45ee6}]{Genetics}
\begin{itemize}
...
\begin{frame}[label={sec:orge7554d4}]{Diagnostic Tests}
\begin{itemize}
...
\begin{frame}[label={sec:org7e27630}]{Treatment}
\begin{itemize}
