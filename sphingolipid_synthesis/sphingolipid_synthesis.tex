...
\begin{frame}[label={sec:orgheadline3}]{Sphingolipid Structure}
\includegraphics[width=\textwidth]{./figures/Sphingolipids_general_structures.png}
\end{frame}



\begin{frame}[label={sec:orgheadline4}]{Biosynthesis}
\begin{block}{ER}
\begin{itemize}
...
\end{itemize}
\item GBA2 is distinct from the lysosomal acid β-glucosidase GBA1 deficient in Gaucher disease
