...
\begin{frame}[label={sec:orgheadline5}]{Partial \& Profound Deficiency}
...
\begin{frame}[label={sec:orgheadline6}]{NBS for partial deficiency}
\begin{itemize}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textheight]{./figures/posts.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textheight]{./figures/decomp.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textheight]{./figures/tempts.pdf}
\label{fig:temp}
\end{figure}
\end{frame}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textheight]{./figures/formmts.pdf}
\label{fig:cards}
\end{figure}
\end{frame}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textheight]{./figures/allts.pdf}
\label{fig:all}
\end{figure}
\end{frame}
\end{document}
