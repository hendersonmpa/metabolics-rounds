...
- two specific mutations in exon 3 (GSD IIIb)
  - liver only 
** Clinical Presentation
- a hepatic glycogenosis and (in most cases) also myopathic
- present in the first year with poor growth, delayed motor milestones
  and abdominal distension
- Fasting hypoglycaemia occur
...
- mutation analysis
** Treatment
- aim of treatment is to maintain normoglycaemia, reduce the
  hyperlipidaemia and ketosis and ensure adequate growth.
- regular meals and the use of uncooked cornstarch.
...
- Progressive liver disease in infancy.
  ...
  - Cirrhosis develops with eventual end stage liver disease and portal hypertension.
...
- PHK is a multi-enzyme complex consisting of four homo-tetramers,
- a homotetramer in which each subunit is itself a tetramer
  - \alpha, \beta, \gamma and \delta subunit.
