...
\label{sec:org21e9873}

\begin{frame}[label={sec:org9efda3e}]{Hepatic Glycogenoses}
\scriptsize
\begin{center}
\begin{tabular}{llll}
...
\begin{frame}[label={sec:orgc6609aa}]{Diagnostic Tests}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb6d4ad8}]{Treatment}
\begin{itemize}
